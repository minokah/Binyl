...
token\+\_\+type \mbox{\hyperlink{classdetail_1_1lexer_abefd991e3a77297b30698495531f01df}{scan\+\_\+literal}} (const char\+\_\+type $\ast$literal\+\_\+text, const std\+::size\+\_\+t length, token\+\_\+type return\+\_\+type)
\item 
...
char\+\_\+int\+\_\+type {\bfseries current} = std\+::char\+\_\+traits$<$char\+\_\+type$>$\+::eof()
...
const char $\ast$ {\bfseries error\+\_\+message} = \char`\"{}\char`\"{}
...
JSON\+\_\+\+HEDLEY\+\_\+\+RETURNS\+\_\+\+NON\+\_\+\+NULL static JSON\+\_\+\+HEDLEY\+\_\+\+CONST const char $\ast$ {\bfseries token\+\_\+type\+\_\+name} (const \mbox{\hyperlink{classdetail_1_1lexer__base_add65fa7a85aa15052963809fbcc04540}{token\+\_\+type}} t) noexcept
...
For input \char`\"{}\textbackslash{}u c1 c2 c3 c4\char`\"{} the codepoint is\+: (c1 $\ast$ 0x1000) + (c2 $\ast$ 0x0100) + (c3 $\ast$ 0x0010) + c4 = (c1 \texorpdfstring{$<$}{<}\texorpdfstring{$<$}{<} 12) + (c2 \texorpdfstring{$<$}{<}\texorpdfstring{$<$}{<} 8) + (c3 \texorpdfstring{$<$}{<}\texorpdfstring{$<$}{<} 4) + (c4 \texorpdfstring{$<$}{<}\texorpdfstring{$<$}{<} 0)
...
Will never contain EOF (an arbitrary value that is not a valid char value, often -\/1), because 255 may legitimately occur. May contain NUL, which should be escaped. \mbox{\Hypertarget{classdetail_1_1lexer_a505c0c6842a668fc4e9f07dca49b91e9}\label{classdetail_1_1lexer_a505c0c6842a668fc4e9f07dca49b91e9}} 
